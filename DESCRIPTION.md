...
**_Algumas considerações sobre o objeto JSON acima:_**
...
- Efetue o `commit` de todos os passos do desenvolvimento em um **_git público_** de sua preferência e disponibilize apenas o link para o repositório.

---

## Considerações finais

O que será avaliado no teste é como o **_código foi escrito_** e a **_lógica_** por trás dele, então caso não consiga completar 100% dos requisitos, entregue o teste.
